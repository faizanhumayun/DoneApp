...
@section('content')
    <div class="p-6 lg:p-8" x-data="projectCreator()" x-init="init()">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex items-center gap-3 text-sm text-[#706f6c] dark:text-[#A1A09A] mb-4">
                    ...
                    <span>/</span>
                    <span class="text-[#1b1b18] dark:text-[#EDEDEC]">Create</span>
                </div>
                <h1 class="text-3xl font-semibold mb-2">Create New Project</h1>
            ...
            <form method="POST" action="{{ route('projects.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('non_billable_resource') }}"
                                    step="0.01"
                                    min="0"
                ...
                <!-- Team Members Card -->
                <div class="bg-white dark:bg-[#161615] rounded-lg shadow-sm p-6 border border-[#e3e3e0] dark:border-[#3E3E3A]">
                    <h2 class="text-xl font-semibold mb-6 text-[#1b1b18] dark:text-[#EDEDEC]">Team Members (Optional)</h2>
